...
class My_Arm:
    ...
    def init(self):
        ...
        self.AK.setPitchRangeMoving(self.init_position, -30, -30, 0, 1500)
    ...
    def reset_arm_position(self):
        ...
        time.sleep(0.5)
        Board.setBusServoPulse(2, 500, 500)
        self.AK.setPitchRangeMoving(self.init_position, -30, -30, -90, 1500)
        time.sleep(1.5)
        ...
        while True:
            if self.is_running:
                if self.bull_detected:
                    ...
                    self.AK.setPitchRangeMoving(self.raised_position, -90, -90, 0)
                    time.sleep(0.02)
